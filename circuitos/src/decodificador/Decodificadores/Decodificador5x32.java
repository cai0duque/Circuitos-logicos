...
public class Decodificador5x32 extends Decodificador implements OperacoesDecodificador {
    private int A, B, C, D, E;
    private final Scanner scanner = new Scanner(System.in);

    @Override
    public void calcularSaida() {
        int saida = (A << 4) | (B << 3) | (C << 2) | (D << 1) | E;
        String valoresLogicos = "A" + A + ", B" + B + ", C" + C + ", D" + D + ", E" + E;
    ...
    public void realizarOperacao() {
        while (true) {
            try {
                ...
                System.out.println("\nDeseja refazer a operação com Decodificador 5x32?");
